...
parser.add_argument('--cs_ratio', type=int, default=30, help='from {30, 40, 50}')
parser.add_argument('--noise_level', type=int, default=30, help='Poisson noise level')
parser.add_argument('--gpu_list', type=str, default='0', help='gpu index')
parser.add_argument('--task_id', type=int, default=3, help='the task id: CPR-3')
parser.add_argument('--matrix_dir', type=str, default='../CPR/sampling_matrix', help='sampling matrix directory')
parser.add_argument('--model_dir', type=str, default='model', help='trained or pre-trained model directory')
parser.add_argument('--data_dir', type=str, default='../CPR/data', help='training or test data directory')
parser.add_argument('--log_dir', type=str, default='log', help='log directory')
parser.add_argument('--result_dir', type=str, default='result', help='result directory')
parser.add_argument('--test_name', type=str, default='prdeep12', help='name of test set')
...
with torch.no_grad():
    ...
    for i in range(nrtest):
        ...
        SampM_data_Name = './%s/SampM_%d_128.mat' % (args.matrix_dir,cs_ratio)
        ...
        rec_PSNR = psnr(Prediction_value.squeeze(1).squeeze(0)*255, Testing_labels[i, :, :]*255)
        rec_SSIM = ssim(Prediction_value.squeeze(1).squeeze(0)*255, Testing_labels[i, :]*255, data_range=255)
