...
model_dir = "./%s/BCS_noiseless_learned_DPUNet_layer_%d_group_%d" % (args.model_dir, layer_num, group_num)

log_file_name = "./%s/Log_BCS_noiseless_learned_DPUNet_layer_%d_group_%d.txt" % (args.log_dir, layer_num, group_num)
